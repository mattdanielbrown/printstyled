/* eslint-disable capitalized-comments, arrow-parens, padding-line-between-statements */
'use strict';
...
${yellowTitle('Usage')}
${dollarSign()} colortext ${commandOption('TEXT')} [${commandOption(
	'COLOR')}] [${commandOption('STYLE(S)...')}]
